...
class TestODMLoader(TestCase):
    def setUp(self) -> None:
        ...
        self.loader = LD.ODMLoader(OL.XMLDefineLoader(model_package="arm_1_0", ns_uri="http://www.cdisc.org/ns/arm/v1.0"))
    ...
    def test_open_odm_document(self):
        ...
        self.assertEqual("wwww.cdisc.org/CDISC-Sample/ADaM/1/Define-XML_2.1.0", root.attrib["FileOID"])
